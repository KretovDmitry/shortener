...
//
//	mockgen -source=internal/db/storage.go -destination=internal/mock/mock_storage.go
//
...
func (m *MockURLStorage) DeleteURLs(ctx context.Context, urls ...*models.URL) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range urls {
...
func (mr *MockURLStorageMockRecorder) DeleteURLs(ctx any, urls ...any) *gomock.Call {
...
func (m *MockURLStorage) GetAllByUserID(ctx context.Context, userID string) ([]*models.URL, error) {
	m.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) GetAllByUserID(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllByUserID", reflect.TypeOf((*MockURLStorage)(nil).GetAllByUserID), ctx, userID)
}
